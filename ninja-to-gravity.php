...
define( 'NINJA_TO_GRAVITY_PATH', untrailingslashit( plugin_dir_path( __FILE__ ) ) );
define( 'NINJA_TO_GRAVITY_URL', untrailingslashit( plugin_dir_url( __FILE__ ) ) );

define( 'NINJA_TO_GRAVITY_TEMPLATES_PATH', NINJA_TO_GRAVITY_PATH . DIRECTORY_SEPARATOR . 'templates' );

require_once NINJA_TO_GRAVITY_PATH . DIRECTORY_SEPARATOR . 'class-ninja-forms.php';
...
function add_ninja_form_option() {
	...
	include NINJA_TO_GRAVITY_TEMPLATES_PATH . DIRECTORY_SEPARATOR . 'import-form.php';
